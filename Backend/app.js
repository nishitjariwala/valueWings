...
//file having path of all user authentication related api
var apiUserManagementRouter = require('./routes/user_management');
var apiNewsManagementRouter = require('./routes/news_management');
var apiCarManagement = require('./routes/car_management');
...
// Authentictation API url
app.use('/api/user/', apiUserManagementRouter);
app.use('/api/news/', apiNewsManagementRouter);
app.use('/api/cars/',apiCarManagement)
